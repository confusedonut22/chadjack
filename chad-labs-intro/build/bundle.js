...
const getBootIntensity = (frame, delay) => {
  const local = frame - delay;
  if (local <= 0) {
    return 0;
  }
  if (local < startupSamples.length * 3) {
    const sampleIndex2 = Math.min(
      startupSamples.length - 1,
      Math.floor(local / 3)
    );
    const ramp = (0,esm.interpolate)(local, [0, startupSamples.length * 3], [0, 0.78], {
      extrapolateLeft: "clamp",
      extrapolateRight: "clamp"
    });
    return clamp(startupSamples[sampleIndex2] * 0.7 + ramp * 0.5, 0, 0.92);
  }
...
const ChadLabsIntro = () => {
  ...
  const logoOpacity = (0,esm.interpolate)(frame, [0, 2, 6], [0.2, 0.8, 1], {
    easing: esm.Easing.out(esm.Easing.cubic),
    extrapolateRight: "clamp"
  });
  const scale = (0,esm.interpolate)(settle, [0, 1], [0.96, 1]);
  ...
  const labsGlow = (0,esm.interpolate)(labsAverage, [0, 1], [0.2, 1.2]);
  const descentStart = 0;
  const contactFrame = 94;
  const chadReveal = (0,esm.interpolate)(frame, [contactFrame - 1, contactFrame + 3], [0, 1], {
    easing: esm.Easing.out(esm.Easing.cubic),
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  const chadLift = (0,esm.interpolate)(frame, [descentStart, contactFrame], [0, 122], {
    easing: esm.Easing.inOut(esm.Easing.cubic),
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  const chadBrightness = (0,esm.interpolate)(frame, [contactFrame - 1, contactFrame + 5], [0.16, 1.12], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  const chadContrast = (0,esm.interpolate)(frame, [contactFrame - 1, contactFrame + 8], [0.86, 1.18], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  const chadShadow = (0,esm.interpolate)(frame, [0, contactFrame - 1, contactFrame + 5], [0.96, 0.96, 0], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  const contactBloom = (0,esm.interpolate)(frame, [contactFrame - 4, contactFrame + 4, contactFrame + 16], [0, 1, 0.18], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  const reflectionStart = 108;
  const reflectionDuration = 26;
  const reflectionProgress = (0,esm.interpolate)(
    frame,
  ...
  const reflectionOpacity = (0,esm.interpolate)(
    frame,
  ...
  const reflectionX = (0,esm.interpolate)(reflectionProgress, [0, 1], [0.31, 0.84]);
  const floorOpacity = (0,esm.interpolate)(labsAverage, [0, 1], [0.08, 0.74]);
  const floorBlur = (0,esm.interpolate)(labsAverage, [0, 1], [22, 42]);
  const bridgeGlow = (0,esm.interpolate)(frame, [contactFrame - 6, contactFrame, contactFrame + 10], [0, 0.42, 0.12], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(
    ...
    {
      style: {
        background: "radial-gradient(circle at 50% 38%, rgba(20, 20, 54, 0.9) 0%, rgba(7, 8, 25, 0.98) 42%, rgba(2, 3, 12, 1) 76%)",
        color: "white",
      ...
      children: [
        /* @__PURE__ */ (0,jsx_runtime.jsx)(
          ...
          {
            style: {
              background: "radial-gradient(circle at 50% 40%, rgba(34, 28, 92, 0.24) 0%, rgba(34, 28, 92, 0.08) 22%, rgba(0, 0, 0, 0) 58%)",
              opacity: 0.96
            }
          }
        ),
        /* @__PURE__ */ (0,jsx_runtime.jsx)(
          ...
          {
            style: {
              background: "linear-gradient(180deg, rgba(255,255,255,0.03) 0%, rgba(255,255,255,0) 24%, rgba(0,0,0,0) 62%, rgba(0,0,0,0.42) 100%)"
            }
          }
        ),
        /* @__PURE__ */ (0,jsx_runtime.jsxs)(
          "div",
          {
            style: {
              ...
              width: logoSize,
              height: logoSize,
              transform: `translate(-50%, -47%) scale(${scale})`,
              opacity: logoOpacity
            },
            children: [
              /* @__PURE__ */ (0,jsx_runtime.jsx)(
                "div",
                {
                  style: {
                    ...
                    borderRadius: 999,
                    background: "linear-gradient(90deg, rgba(40,135,255,0.72) 0%, rgba(63,228,255,0.9) 16%, rgba(146,255,73,0.78) 37%, rgba(255,211,72,0.84) 62%, rgba(255,94,56,0.82) 82%, rgba(255,74,164,0.72) 100%)",
              ...
              /* @__PURE__ */ (0,jsx_runtime.jsx)(
                "div",
                {
                  style: {
                    ...
                    transform: "translateX(-50%)",
                    borderRadius: "50%",
                    background: "radial-gradient(circle, rgba(255,214,97,0.95) 0%, rgba(255,214,97,0.42) 26%, rgba(255,214,97,0.08) 56%, rgba(255,214,97,0) 74%)",
                    filter: "blur(18px)",
                ...
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ (0,jsx_runtime.jsx)(
                      "div",
                      {
                        style: {
                          position: "absolute",
                          inset: 0,
                          background: "linear-gradient(180deg, rgba(5,7,18,1) 0%, rgba(5,7,18,0.96) 100%)",
                          opacity: 0.98,
                          maskImage: `url("${(0,esm.staticFile)("logo-chad.png")}")`,
                          maskSize: "contain",
                          maskRepeat: "no-repeat",
                          maskPosition: "center",
                          WebkitMaskImage: `url("${(0,esm.staticFile)("logo-chad.png")}")`,
                    ...
                    /* @__PURE__ */ (0,jsx_runtime.jsx)(
                      esm.Img,
                      {
                        src: (0,esm.staticFile)("logo-chad.png"),
                        style: {
                          width: "100%",
                          height: "100%",
                          objectFit: "contain",
                    ...
                    /* @__PURE__ */ (0,jsx_runtime.jsx)(
                      "div",
                      {
                        style: {
                          position: "absolute",
                          inset: 0,
                          background: "linear-gradient(180deg, rgba(2,3,12,0.96) 0%, rgba(2,3,12,0.72) 56%, rgba(2,3,12,0.22) 100%)",
                          opacity: chadShadow,
                          maskImage: `url("${(0,esm.staticFile)("logo-chad.png")}")`,
                          maskSize: "contain",
                          maskRepeat: "no-repeat",
                    ...
                    /* @__PURE__ */ (0,jsx_runtime.jsx)(
                      "div",
                      {
                        style: {
                          position: "absolute",
                          inset: 0,
                          background: "linear-gradient(180deg, rgba(255,244,200,0.22) 0%, rgba(255,244,200,0.08) 36%, rgba(255,244,200,0) 76%)",
                ...
                "div",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ (0,jsx_runtime.jsx)(
                      esm.Img,
                      {
                        src: (0,esm.staticFile)("logo-labs-cutout.png"),
                        style: {
                          position: "absolute",
                          left: 0,
                          top: 0,
                    ...
                    /* @__PURE__ */ (0,jsx_runtime.jsx)(
                      "div",
                      {
                        style: {
                          position: "absolute",
                          inset: 0,
                          background: "linear-gradient(180deg, rgba(255,255,255,0.16) 0%, rgba(255,255,255,0) 34%, rgba(255,255,255,0) 100%)",
                          opacity: 0.18 + labsAverage * 0.16,
                          maskImage: `url("${(0,esm.staticFile)("logo-labs-cutout.png")}")`,
                          maskSize: "contain",
                          maskRepeat: "no-repeat",
                          maskPosition: "center",
                          WebkitMaskImage: `url("${(0,esm.staticFile)("logo-labs-cutout.png")}")`,
                          WebkitMaskSize: "contain",
                          WebkitMaskRepeat: "no-repeat",
                          WebkitMaskPosition: "center"
                        }
                    ...
                    /* @__PURE__ */ (0,jsx_runtime.jsx)(
                      "div",
                      {
                        style: {
                          ...
                          transform: "translateX(-50%)",
                          borderRadius: 999,
                          background: "linear-gradient(90deg, rgba(31,150,255,0.9) 0%, rgba(143,255,84,0.9) 36%, rgba(255,201,47,0.92) 64%, rgba(255,86,126,0.88) 100%)",
...
var renderContent = (Root) => {
  ...
  if (bundleMode.type === "index") {
    ...
    Promise.all(/* import() */[__webpack_require__.e(58), __webpack_require__.e(845)]).then(__webpack_require__.bind(__webpack_require__, 3058)).then(({ StudioInternals }) => {
...
/******/ 	(() => {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "chad-labs-intro:";
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkchad_labs_intro"] = self["webpackChunkchad_labs_intro"] || [];
