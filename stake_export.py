        ...
        json.dump(
            {
                ...
                "notes": [
                    ...
                    "Supports same-rank split rounds, split aces receive one card each, DAS=False, and no re-splitting.",
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Emit a deterministic Stake-style blackjack math bundle.")
    parser.add_argument("--rounds", type=int, default=5000)
    parser.add_argument("--seed", type=int, default=1337)
    parser.add_argument("--out-dir", default="stake_submission_bundle")
