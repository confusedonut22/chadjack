<script>
  ...
  import { PHASE, SPEEDS, MONEY_SCALE, CHIPS, CHIP_IMAGES, LOGO_IMAGE, C } from "../game/constants.js";
...
<div class="table-wrap">
  ...
  <!-- FELT AREA -->
  <div class="felt" class:single-hand={!multi} on:click={closePanels}>
...
<style>
  ...
  @media (max-width: 767px) {
    ...
    /* Compact dealer */
    .dealer-area        { min-height: 80px; gap: 8px; }
    ...
    .dealer-pays-wrap   { margin-top: 6px; gap: 2px; }
    ...
    .felt.single-hand .dealer-cards-col .card-hidden {
      background: linear-gradient(155deg, #244a30 0%, #16321e 100%);
      border: 1px solid rgba(242,232,208,0.7);
      box-shadow:
        inset 0 0 0 1px rgba(242,232,208,0.14),
    ...
    .felt.single-hand .dealer-cards-col .card-hidden::before {
      ...
      background: linear-gradient(160deg, rgba(255,255,255,0.04), rgba(0,0,0,0.08));
      pointer-events: none;
    }
    ...
    .felt.single-hand .dealer-cards-col .card-rank { font-size: 17px; }
    .felt.single-hand .dealer-cards-col .card-suit-sm { font-size: 14px; }
    .felt.single-hand .dealer-cards-col .card-center { font-size: 34px; }
    .felt.single-hand .hand-value {
      margin-bottom: 6px;
    }
    .felt.single-hand .dealer-pays-wrap {
      margin-top: 10px;
      gap: 4px;
    }
    .felt.single-hand .dealer-pays-line {
      width: min(176px, 52vw);
    }
    .felt.single-hand .dealer-pays-copy {
      font-size: 10px;
      line-height: 1.1;
    }
    .sb-box,
